...
class QuarkDriveService implements CloudDriveService {
  ...
  static const String _apiBase = 'https://drive-pc.quark.cn/1/clouddrive/';
  static const String _pr = 'pr=ucpro&fr=pc';
  static const String _userAgent =
      'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) quark-cloud-drive/2.5.20 Chrome/100.0.4896.160 Electron/18.3.5.4-b478491100 Safari/537.36 Channel/pckk_other_ch';
  static const String _refererUrl = 'https://pan.quark.cn/';
  static const String _host = 'https://quark.cn';
  static const String _cookieKey = 'https://quarkcookie.last';
  ...
  @override
  CloudDriveType get type => CloudDriveType.quark;
  ...
  Future<bool> loginByQR() async {
    throw UnimplementedError(
      'QR login is not yet supported for QuarkDrive.',
    );
  }

  @override
  Future<void> logout() async {
    _account = CloudDriveAccount(type: CloudDriveType.quark);
    _lastCookie = '';
    ...
    await CloudCookieManager.clear(CloudDriveType.quark);
  }
  ...
  Future<List<Video>> getVideos(String encodedUrl) async {
    ...
    final subtitleInfos = subtitlePart.isNotEmpty ? subtitlePart.split('+') : <String>[];
  ...
  Future<bool> refreshAuth() async {
    // Hit a lightweight endpoint to trigger set-cookie.
    // The _api helper already handles __puus extraction from set-cookie
    // headers, so this method just needs to persist any updates.
    try {
      final result = await _api(
        'file/sort?$_pr&pdir_fid=0&_page=1&_size=1&_sort=file_type:asc,updated_at:desc',
        <String, dynamic>{},
